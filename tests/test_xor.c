...
Test(xor_instruction, register_and_direct_to_register_one)
{
    ...
    prog.reg[1][3] = 7;
    xor_instruction(NULL, NULL, &prog, core);
    cr_assert_eq(prog.reg[0][3], 7 ^ 6);
}

Test(xor_instruction, direct_and_register_to_register_one)
{
...
Test(xor_instruction, indirect_and_indirect_to_register_one)
{
...
Test(xor_instruction, bad_parameters)
{
    ...
    int status = 0;
    status = xor_instruction(NULL, NULL, &prog, core);
